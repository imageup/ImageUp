...
entry:
  ...
  %adjust_contrast_result = call [3000000 x double]* @adjust_contrast([3000000 x double]* %a1, double 1.100000e+00)
  store [3000000 x double]* %adjust_contrast_result, [3000000 x double]** %output
